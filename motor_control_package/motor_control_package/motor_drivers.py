...
class MotorDriver(Node):
    ...
    def __init__(self):
        ...
        self.motors.append(PWM(topic='/motor/tread_left', pin=16, freq=50, min_dc=0, max_dc=100, init_range=0))
        self.motors.append(PWM(topic='/motor/tread_right', pin=16, freq=50, min_dc=0, max_dc=100, init_range=0))
