...
def main(args=None):
    ...
    node = ActuatorSensor(signal_topic='/motor/bucket_angle_joint', pos_topic='/sensor/bucket_joint', node='bucket_sensor', extension_time=10000) #instantiate a node (starts node)
